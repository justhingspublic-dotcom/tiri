...
本輪包含首頁重整、五個委員會內頁、歷屆理監事表格、活動整合、課程／評估流程、證照與獎項分組、知識配圖與搜尋、會員權利及中英文年刊封面。網站目前 143 個 HTML；搜尋索引排除轉址頁後為 131 頁。

- [本輪 Checklist](../V1修改Checklist.md)
- [驗收入口](../outputs/2026-09-09-v1-revision/驗收入口.html)
- [QA 與缺件](../outputs/2026-09-09-v1-revision/QA報告.md)

新增共用樣式在 `css/revision.css`。舊 `events.html`、獎學金獨立頁保留轉址；理監事仍以 `board.html?term=` 切換，入口直接第三屆。本機版本尚未部署線上測試站。
