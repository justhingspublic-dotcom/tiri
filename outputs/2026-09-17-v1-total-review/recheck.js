...
(() => {
  ...
  $('delivery-notice').textContent = '測試站總複檢：全部 46 項已重新開放；第 33、42 項已依本輪回報修正，請以最新內容檢查。前 11 輪紀錄均保留。';
