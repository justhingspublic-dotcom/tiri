...
(() => {
  ...
  $('delivery-notice').textContent = '17 已依本輪對話確認通過。全部 45 項已通過，0 項待複檢；歷次留言、修改與通過紀錄完整保留。';
  ...
  function exportResults() {
    ...
    link.href=url; link.download='TIRI-v1-第八輪複檢結果.json'; document.body.append(link); link.click(); link.remove();
