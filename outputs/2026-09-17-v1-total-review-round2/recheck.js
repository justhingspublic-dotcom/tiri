...
(() => {
  ...
  $('delivery-notice').textContent = '第二輪：第一輪 45 項已通過；第 46 項英文優惠介面已修正，另新增第 47、48 項捲動與內容顯示調整，共 3 項待複檢。';
  ...
  function exportResults() {
    ...
    link.href=url; link.download='TIRI-v1-總複檢第二輪結果.json'; document.body.append(link); link.click(); link.remove();
