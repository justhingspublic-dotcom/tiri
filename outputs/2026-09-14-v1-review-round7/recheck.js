...
(() => {
  ...
  $('delivery-notice').textContent = '本輪修正 17、25 兩項；23 沿用前輪 Banner 待確認。42 項已通過、3 項可複檢，全部 45 項與歷次留言保留。';
  ...
  function exportResults() {
    ...
    link.href=url; link.download='TIRI-v1-第七輪複檢結果.json'; document.body.append(link); link.click(); link.remove();
