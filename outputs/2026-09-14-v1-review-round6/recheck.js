...
(() => {
  ...
  $('delivery-notice').textContent = `${readyCount} 項已實際修改、可複檢${partialCount ? `；${partialCount} 項部分完成，限制已寫在卡片內` : ''}。${items.filter(item => item.reviewStatus === 'accepted').length} 項已通過紀錄與歷次留言完整保留；會議原項目尚有 17、23、25、41 四項初稿待定稿；實作備註留待最後檢視。`;
