...
(() => {
  ...
  $('delivery-notice').textContent = '32 第一屆名單已更新為 20 家正式得獎，待本輪複檢；其餘 44 項已通過，全部 45 項與歷次驗收紀錄保留。';
  ...
  function exportResults() {
    const result = {
      ...
      sourceExportedAt:data.sourceExportedAt, sourceType:data.sourceType, sourceRecordedAt:data.sourceRecordedAt, contentDecision:data.contentDecision, exportedAt:timestamp(),
    ...
    link.href=url; link.download='TIRI-v1-第九輪複檢結果.json'; document.body.append(link); link.click(); link.remove();
